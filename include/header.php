                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4">
                            <div class="header__info">
                                <div class="logo">
                                    <a href="index.html" class="logo-image"><img src="upload/nama.png" alt="logo"></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- <div class="col-xl-4 col-lg-5 col-md-8 col-sm-8">
                            <div class="header-action">
                                <div class="block-userlink">
                                    <a class="icon-link icon-link-2" href="login/index.php">
                              ...
                              <?php  $id_pelanggan = $_GET['id_pelanggan']; ?>
                                    <a class="icon-link icon-link-2" href="dashboard.php?module=cart&id_pelanggan=<?php echo $id_pelanggan; ?>">
                                    <i class="flaticon-user"></i>
                                    <span class="text">
                                    <span class="sub">Keranjang </span>
                                ...
                                <div class="block-wishlist action">
                                    ...
                                    Wishlist Sepatu </span>
                                    </a>
                                </div>
                                <div class="block-cart action">
                                    <a class="icon-link icon-link-2" href="dashboard.php?module=cart&id_pelanggan=<?php $id_pelanggan; ?>">
                                            ...
                                            <ul>
                                                <li>
                                                  <div class="cart__title">
                                                    <h4>Keranjang</h4>
                                                    <span>(1 Item di keranjang mu)</span>
                                                  </div>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                  <div class="cart__sub d-flex justify-content-between align-items-center">
                                                    <h6>Subtotal</h6>
                                                    <span class="cart__sub-total">Rp.4.000.000,00</span>
                                                  </div>
                                                </li>
                                                <li>
                                                    <a href="dashboard.php?module=cart&id_pelanggan=<?php echo $kat['id_pelanggan']; ?> "class="wc-cart mb-10">View cart</a>
                        ...
                        <div class="main-menu d-none d-lg-block">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="dashboard.php?module=about">About Us</a></li>
                                    <li><a href="dashboard.php?module=pelanggan">Product</a></li>
                                    <li><a href="login/logout.php">Log Out</a></li>
                                    <li><a href="dashboard.php?module=cart&id_pelanggan=<?php echo $id_pelanggan; ?>">Keranjang</a></li>
                                    <!-- <li><a href="dashboard.php?module=cart&id_pelanggan=<?php echo $id_pelanggan; ?>">Halo, <?php echo $nama_pelanggan; ?></a></li> -->
                                    <li><div class="block-userlink">
                                    <a class="icon-link" href="dashboard.php?module=profile&id_pelanggan=$id_pelanggan">
                                    <i class="flaticon-user"></i> 
                                    <span class="text">
                                    
                                    <?php echo $nama_pelanggan; ?> </span>
                                    </a>
                                     <!-- <li><a href="dashboard.php?module=riwayat&id_pelanggan=<?php echo $id_pelanggan; ?>">Riwayat Pembelian</a></li> --> 
                                </div>
                                </li>
                                </ul>
                            </nav>
