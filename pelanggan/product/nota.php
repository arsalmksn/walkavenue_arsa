...
WHERE 
    pp.id_pelanggan = '$id_pelanggan' AND pp.tgl_nota_penjualan='$tgl_penjualan' AND dp.kode_transaksi='$kode_transaksi'");
...
<div class="container mt-5">
    <div class="card">
        <div class="card-header text-center">
            ...
            <p>Nomor Transaksi: TR<?php echo $tgl_penjualan; ?></p>
        </div>
        <div class="card-body">
